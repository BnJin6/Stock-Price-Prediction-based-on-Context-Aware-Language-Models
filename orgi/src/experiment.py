...
class CrossValidatedTBLNew(Experiment, UndersampleTweetsMixin, ExtractWindowsMixin, ExtractTweetsMixin, ShuffleTweetPacksMixin, StoreResultsMixin):
    def __init__(
        self,
        price_df_addr="raw/daily-2020.csv",
        text_df_addr="raw/combined_tweets_2020_labeled.csv",
        ...
        super().__init__(
            id=1,
            base_addr=".",
            model=CryptoBERT(model_addr="ProsusAI/finbert"),
            logger=logger,
            description="""
                comparing base cryptoBERT model to finetuned cryptoBERT on impact direction labelings
                """,
